...
# ---------------------------------------------------------------------------
# JSON schema for the propose-first response — used by the 1-shot agent to
# coax structured output from providers that honour ``response_format``.
# ---------------------------------------------------------------------------


def query_schema() -> dict:
    """JSON Schema for the ``{"query": "..."}`` reply shape."""
    return {
        "type": "object",
